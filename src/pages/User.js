...
export default function User() {
            ...
            {loading ? <Loader /> : user &&
                <Container className="mt-5">
                    ...
                    <Row className="d-flex justify-content-center">
                        ...
                        <Col xs="12" md="8" lg="" className="d-flex flex-column justify-content-center align-items-md-start align-items-center
 ...
 mt-2">
                        ...
                        <Col xs="6" sm="6" md="4" className="d-flex justify-content-center mt-3">
                            <Button variant="dark">Visitar repositórios</Button>
                        </Col>
                        <Col xs="6" sm="6" md="4" className="d-flex justify-content-center mt-3">
                            <Button variant="dark">Visitar stareds</Button>
                        </Col>
                    </Row>
                </Container>
            }
